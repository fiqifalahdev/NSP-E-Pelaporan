...
Route::prefix('/auth')->group(function () {
    ...
    Route::post('/login', [LoginBasic::class, 'authenticate'])->name('login');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    // HIRADC
    Route::prefix('hiradc')->resource('hiradc', HiradcController::class);

    Route::post('hiradc/{hiradc}/verify', [HiradcController::class, 'verify'])->name('hiradc.verify');
    ...
    Route::get('/hiradc/{id}/export-pdf', [HiradcController::class, 'exportPDF'])->name('hiradc.export-pdf');
    Route::get('/toolbox-meetings/{id}/export-pdf', [ToolboxMeetingController::class, 'exportPDF'])->name('toolbox-meetings.export-pdf');
});
